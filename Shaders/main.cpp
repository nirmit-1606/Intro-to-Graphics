...
const char *WINDOWTITLE = { "Shaders Deformation Animation" };
...
bool vertAnimation = true;
bool fragAnimation = true;
...
Display( )
{
	...
	Pattern->SetUniformVariable("uColor", 0.2, 0.2, 0.3);
	...
	{ 
		...
		Pattern->SetUniformVariable("uDt", Dt * (float)(.5 + .5 * sin(2. * M_PI * Time)));
	}
