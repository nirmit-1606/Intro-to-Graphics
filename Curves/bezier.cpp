...
const char *WINDOWTITLE = { "Bezier Curve Animation" };
const char *GLUITITLE   = { "Bezier Curves" };
...
DrawButterfly()
{
	...
	for (size_t i=0; i<16; i++) {
		Curve body = {
			.06 * i * cos(2. * M_PI * Time), .4, 0.05 * i * sin(4. * M_PI * Time),
			head,
			{-1.15, .3 * cos(i), .3 * sin(i)},
			{.3, .3 * cos(i), .3 * sin(i)},
			tail
		};
		DrawCurve(body);
	...
	Curve right_anteena = {
		.8, .3, .2,
		{-1., .1, -.1},
		{-2.5 + .2 * cos(2. * M_PI * Time), .2, 0.},
		{-2.1, .25, -.8 + .05 * cos(2. * M_PI * Time)},
		{-2. + .2 * cos(2. * M_PI * Time), .3, -.5 + .05 * cos(2. * M_PI * Time)}
	};
	Curve left_anteena = {
		.8, .3, .2,
		{-1., .1, .1},
	...
	DrawCurve(right_anteena);
	DrawCurve(left_anteena);

	Point wing_start = {-1., .1, 0.};
	Point wing_end = {.6, .1, 0.};
	
	Curve right_wing_front = {
		.5 * cos(4. * M_PI * Time), .6 * sin(4. * M_PI * Time), .2,
		wing_start,
		{2.5 * wing_start.x, .8 + .3 * cos(4. * M_PI * Time), -2. + .1 * cos(4. * M_PI * Time)},
		{.5 * wing_start.x, .4 + .3 * cos(4. * M_PI * Time), -1.5 + .1 * cos(4. * M_PI * Time)},
		{0. , .4 + 0.2 * cos(4. * M_PI * Time), -1. + .05 * cos(4. * M_PI * Time)}
	};
	Curve right_wing_back = {
		.5 * cos(4. * M_PI * Time), .6 * sin(4. * M_PI * Time), .2,
		{0. , .4 + 0.2 * cos(4. * M_PI * Time), -1. + .05 * cos(4. * M_PI * Time)},
		{1.3 * wing_end.x, .6 + .3 * cos(4. * M_PI * Time), -1.3 + .1 * cos(4. * M_PI * Time)},
		{2.4 * wing_end.x, .4 + .3 * cos(4. * M_PI * Time), -1.3 + .1 * cos(4. * M_PI * Time)},
		wing_end
	};
	Curve left_wing_front = {
		.5 * cos(4. * M_PI * Time), .6 * sin(4. * M_PI * Time), .2,
		wing_start,
		{2.5 * wing_start.x, .8 + .3 * cos(4. * M_PI * Time), 2. + .1 * cos(4. * M_PI * Time)},
		{.5 * wing_start.x, .4 + .3 * cos(4. * M_PI * Time), 1.5 + .1 * cos(4. * M_PI * Time)},
	...
	DrawCurve(right_wing_front);
	DrawCurve(right_wing_back);
	DrawCurve(left_wing_front);
	DrawCurve(left_wing_back);
}
